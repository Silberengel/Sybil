...
class WikiFeedCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('identifier', 'i', InputOption::VALUE_REQUIRED, 'Filter by wiki identifier')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->logger->info('Fetching wiki feed', [
            'relay' => $relay,
            'limit' => $limit,
            'author' => $author,
        ...
        try {
            ...
            $this->logger->error('Failed to fetch wiki feed', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString(),
            ]);
            $io->error('Failed to fetch wiki feed: ' . $e->getMessage());
